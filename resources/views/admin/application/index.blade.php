...
@section('title', "DASHBOARD AEON CREDIT SERVICE INDONESIA - APPLICATION")
@section('content')
    ...
    <section class="w-full min-h-[90vh] bg-base-100 p-4 rounded-xl shadow-xl">
        <div class="w-full flex justify-between items-center gap-4 mb-4">
            <h2 class="font-semibold my-0">Application</h2>
        </div>
        <x-alert/>
                ...
                <tr>
                    ...
                    <td>
                        <div class="flex justify-center items-center gap-2">
                            <a 
                            href="{{ url('/admin/application/'.$item->application_id.'/edit') }}"
